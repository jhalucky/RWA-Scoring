    ...
    <div className="min-h-screen bg-deep-space text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="animate-fade-in-up max-w-5xl mx-auto">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 mb-8 px-5 py-2.5 rounded-full bg-gradient-to-r from-laser-blue/10 to-electric-cyan/10 border border-laser-blue/20 mt-5">
              <div className="w-2 h-2 bg-electric-cyan rounded-full animate-pulse"></div>
              <span className="text-sm font-medium text-electric-cyan tracking-wide">POWERED BY MANTLE NETWORK</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4">
              ...
              <button className="px-8 py-4 bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl text-base font-semibold hover:bg-white/10 transition-all duration-300 flex items-center gap-2">
                <FileText size={20} />
                View Documentation
              </button>
            </div>
          ...
          <div className="glass-card p-12 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="px-8 py-4 glass-card rounded-lg body-lg font-semibold hover:bg-white/5 transition-colors">
                  Read Docs
                </button>
              </div>
            </div>
      ...
      <footer className="border-t border-subtle-border py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-subtle-border pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="body-sm text-white/50">
              Built for Mantle Hackathon • © 2024 RWA Tokenization Platform. All rights reserved.
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 bg-gradient-to-br from-laser-blue to-electric-cyan rounded flex items-center justify-center">
                <Zap size={14} className="text-white" />
              </div>
              <span className="body-sm text-white/70">Powered by Mantle</span>
            </div>
          </div>
        </div>
      </footer>
